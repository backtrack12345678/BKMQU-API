...
-- AddForeignKey
ALTER TABLE `Kajian_Thumbnail` ADD CONSTRAINT `Kajian_Thumbnail_kajian_id_fkey` FOREIGN KEY (`kajian_id`) REFERENCES `Kajian`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE `Kajian_Konten` ADD CONSTRAINT `Kajian_Konten_kajian_id_fkey` FOREIGN KEY (`kajian_id`) REFERENCES `Kajian`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE `Kajian_Konten_Media` ADD CONSTRAINT `Kajian_Konten_Media_kajian_konten_id_fkey` FOREIGN KEY (`kajian_konten_id`) REFERENCES `Kajian_Konten`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;
