/*
  ...
  - You are about to drop the column `keterangan` on the `kas_arus_dokumen` table. All the data in the column will be lost.
...
-- AlterTable
ALTER TABLE `kas_arus` ADD COLUMN `keterangan` TEXT NULL,
    MODIFY `created_at` DATETIME NOT NULL DEFAULT NOW(),
    MODIFY `updated_at` DATETIME NULL DEFAULT NOW() ON UPDATE NOW();

-- AlterTable
ALTER TABLE `kas_arus_dokumen` DROP COLUMN `keterangan`,
    MODIFY `created_at` DATETIME NOT NULL DEFAULT NOW(),
    MODIFY `updated_at` DATETIME NULL DEFAULT NOW() ON UPDATE NOW();
