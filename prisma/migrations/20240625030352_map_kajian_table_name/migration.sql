/*
  ...
  - You are about to alter the column `created_at` on the `arus_kas` table. The data in that column could be lost. The data in that column will be cast from `DateTime(0)` to `DateTime`.
  - You are about to alter the column `updated_at` on the `arus_kas` table. The data in that column could be lost. The data in that column will be cast from `DateTime(0)` to `DateTime`.
  ...
  - You are about to alter the column `created_at` on the `mutasi` table. The data in that column could be lost. The data in that column will be cast from `DateTime(0)` to `DateTime`.
  - You are about to alter the column `updated_at` on the `mutasi` table. The data in that column could be lost. The data in that column will be cast from `DateTime(0)` to `DateTime`.
  ...
  - You are about to alter the column `created_at` on the `rekap_kas_bulanan` table. The data in that column could be lost. The data in that column will be cast from `DateTime(0)` to `DateTime`.
  - You are about to alter the column `updated_at` on the `rekap_kas_bulanan` table. The data in that column could be lost. The data in that column will be cast from `DateTime(0)` to `DateTime`.
  ...
  - You are about to drop the `Kajian` table. If the table is not empty, all the data it contains will be lost.
  - You are about to drop the `Kajian_Konten` table. If the table is not empty, all the data it contains will be lost.
  - You are about to drop the `Kajian_Konten_Media` table. If the table is not empty, all the data it contains will be lost.
  - You are about to drop the `Kajian_Thumbnail` table. If the table is not empty, all the data it contains will be lost.

*/
-- DropForeignKey
ALTER TABLE `Kajian` DROP FOREIGN KEY `Kajian_user_id_fkey`;

-- DropForeignKey
ALTER TABLE `Kajian_Konten` DROP FOREIGN KEY `Kajian_Konten_kajian_id_fkey`;

-- DropForeignKey
ALTER TABLE `Kajian_Konten_Media` DROP FOREIGN KEY `Kajian_Konten_Media_kajian_konten_id_fkey`;

-- DropForeignKey
ALTER TABLE `Kajian_Thumbnail` DROP FOREIGN KEY `Kajian_Thumbnail_kajian_id_fkey`;
...
-- AlterTable
ALTER TABLE `arus_kas` MODIFY `created_at` DATETIME NOT NULL DEFAULT NOW(),
    MODIFY `updated_at` DATETIME NULL DEFAULT NOW() ON UPDATE NOW();
...
-- AlterTable
ALTER TABLE `mutasi` MODIFY `created_at` DATETIME NOT NULL DEFAULT NOW(),
    MODIFY `updated_at` DATETIME NULL DEFAULT NOW() ON UPDATE NOW();
...
-- AlterTable
ALTER TABLE `rekap_kas_bulanan` MODIFY `created_at` DATETIME NOT NULL DEFAULT NOW(),
    MODIFY `updated_at` DATETIME NULL DEFAULT NOW() ON UPDATE NOW();
...
-- DropTable
DROP TABLE `Kajian_Konten`;

-- DropTable
DROP TABLE `Kajian_Konten_Media`;

-- DropTable
DROP TABLE `Kajian_Thumbnail`;
