/*
  ...
  - You are about to drop the column `subjek` on the `kas_arus_dokumen` table. All the data in the column will be lost.
  ...
  - Made the column `keterangan` on table `kas_arus` required. This step will fail if there are existing NULL values in that column.
...
-- AlterTable
ALTER TABLE `kas_arus_dokumen` DROP COLUMN `subjek`,
