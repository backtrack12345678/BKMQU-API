/*
  ...
  - You are about to drop the column `photo` on the `detail_user` table. All the data in the column will be lost.
  - You are about to drop the column `sampul` on the `detail_user` table. All the data in the column will be lost.
  - You are about to drop the column `source_photo` on the `detail_user` table. All the data in the column will be lost.
  - You are about to drop the column `source_sampul` on the `detail_user` table. All the data in the column will be lost.
  ...
  - You are about to drop the column `source_bukti` on the `dokumen_bukti` table. All the data in the column will be lost.
  ...
  - Added the required column `path` to the `dokumen_bukti` table without a default value. This is not possible if the table is not empty.
...
-- AlterTable
ALTER TABLE `detail_user` DROP COLUMN `photo`,
    DROP COLUMN `sampul`,
    DROP COLUMN `source_photo`,
    DROP COLUMN `source_sampul`,
    MODIFY `created_at` DATETIME NOT NULL DEFAULT NOW(),
    MODIFY `updated_at` DATETIME NULL DEFAULT NOW() ON UPDATE NOW();

-- AlterTable
ALTER TABLE `dokumen_bukti` DROP COLUMN `source_bukti`,
