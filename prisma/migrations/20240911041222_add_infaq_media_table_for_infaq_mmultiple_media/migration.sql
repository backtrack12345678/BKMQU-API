/*
  ...
  - You are about to drop the column `foto` on the `infaq` table. All the data in the column will be lost.
  - You are about to drop the column `path` on the `infaq` table. All the data in the column will be lost.
...
-- AlterTable
ALTER TABLE `infaq` DROP COLUMN `foto`,
    DROP COLUMN `path`,
