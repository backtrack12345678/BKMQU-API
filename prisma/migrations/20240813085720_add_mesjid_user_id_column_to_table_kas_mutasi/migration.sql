/*
  ...
  - Added the required column `mesjid_user_id` to the `kas_mutasi` table without a default value. This is not possible if the table is not empty.
...
-- AlterTable
ALTER TABLE `kas_mutasi` ADD COLUMN `mesjid_user_id` VARCHAR(191) NOT NULL,
